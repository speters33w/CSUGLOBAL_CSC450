 ...
 * Needs JavaFinder.WinRegistry.java. Get it at: https://stackoverflow.com/questions/62289/read-write-to-windows-registry-using-java
 *
 * JavaFinder.JavaFinder - Windows-specific classes to search for all installed versions of java on this system
 ...
 * Modified from <a href="http://www.javaworld.com/javaworld/jw-12-2000/jw-1229-traps.html?page=4">...</a>
 *****************************************************************************/
...
class JavaInfo {
    ...
    /**
     * @return Human-readable contents of this JavaFinder.JavaInfo instance
     ****************************************************************************/
...
public class JavaFinder {
     ...
     *               or JavaFinder.WinRegistry.KEY_WOW64_32KEY to force access to 32-bit registry view,
     *               or JavaFinder.WinRegistry.KEY_WOW64_64KEY to force access to 64-bit registry view
    ...
    private static List<String> searchRegistry(String key, int wow64, List<String> previous) {
        try {
            ...
            for (int i = 0; entries != null && i < entries.size(); i++) {
                ...
                if (!previous.contains(val + "\\bin\\java.exe")) {
                    previous.add(val + "\\bin\\java.exe");
                }
            }
        } catch (Throwable t) {
            t.printStackTrace();
    ...
    /**
     * @return: A list of JavaFinder.JavaInfo with informations about all javas installed on this machine
